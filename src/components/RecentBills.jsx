...
const RecentBills = () => {
  ...
  useEffect(()=>{
    fetch("https://pay-connect-server.vercel.app/bills/latest")
    .then(res=> res.json())
    .then(data => setRecentData(data))
  },[])
  return (
    <div className={theme === "light" ? "bg-linear-to-br from-blue-50 to-indigo-100 py-28 px-4" : "py-28 bg-black px-4"}>
